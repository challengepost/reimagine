...
describe Reimagine2::Configuration do
  ...
  describe "default settings" do
    ...
    it { expect(subject.destroy_user_session_url).to eq 'https://secure.devpost.com/users/logout' }
  end
  ...
  describe "configured settings" do
    before do
      ...
      subject.destroy_user_session_url = 'https://secure.devpost.dev/users/logout'
    end
    ...
    it { expect(subject.destroy_user_session_url).to eq 'https://secure.devpost.dev/users/logout' }
  end
end
