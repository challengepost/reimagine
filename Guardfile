...
guard 'livereload' do
  watch(%r{reimagine/stylesheets/.+$})
  watch(%r{reimagine/.+\.html})
  watch(%r{reimagine/javascripts/.+\.js})
end

guard 'coffeescript', input: 'reimagine/assets/javascripts', output: 'reimagine/javascripts'
